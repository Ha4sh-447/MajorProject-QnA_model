#!/usr/bin/env python3
"""
Option A: 6-Level Bloom's — Training Script
FP32 + LoRA on augmented balanced dataset → question_gen_blooms_6level_model/
"""
...
TRAIN_PATH = "../../dataset/blooms_6level_train.json"
VAL_PATH = "../../dataset/blooms_6level_val.json"
OUTPUT_DIR = "../../question_gen_blooms_6level_model"
...
LEARNING_RATE = 5e-5
EPOCHS = 10          # More epochs for 6 levels
WARMUP_RATIO = 0.1
SEED = 42
...
print("=" * 70)
print("OPTION A: 6-LEVEL BLOOM'S — TRAINING")
print("=" * 70 + "\n")
...
try:
    ...
    for lv, name in [(1,"remember"),(2,"understand"),(4,"analyze"),(5,"evaluate"),(6,"create")]:
